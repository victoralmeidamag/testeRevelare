    ...
    <div class="w-full max-w-md mx-4"> 
        ...
        <form class="w-full" method="POST" action="{{ route('form.login') }}"> 
            ...
            <div class="flex justify-end mb-6">
                <a href="#" class="text-sm text-gray-600 hover:text-gray-900">Esqueceu sua senha?</a>
            </div>
            
            <button 
                type="submit" 
                class="w-full bg-black text-white py-3 px-4 rounded-full font-medium hover:bg-gray-800 transition-colors">
                FAZER LOGIN
            </button>
        </form>
